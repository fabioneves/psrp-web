...
public sealed class StreamTelemetry
{
    ...
    public static string Summary(JsonElement sample)
    {
        ...
        return string.Join(' ', new[] { "t", "fps", "consoleFps", "display", "displayMax", "max", "target", "videoUnderruns", "rebuilt", "dropped", "queue", "arrivalP95", "arrivalMax", "transportP95", "rtt", "mbps", "stalls", "lost", "idr", "underruns" }
