...
public sealed class StreamTelemetry
{
    ...
    public static string Summary(JsonElement sample)
    {
        ...
        return string.Join(' ', new[] { "t", "fps", "consoleFps", "display", "displayMax", "displayed", "displayReplaced", "max", "target", "videoUnderruns", "rebuilt", "dropped", "longTasks", "longTaskMs", "pageRefreshMax", "queue", "transport", "abandoned", "rtcKeyframes", "senderSkipped", "pairRtt", "arrivalP95", "arrivalMax", "transportP95", "rtt", "mbps", "stalls", "lost", "idr", "underruns" }
