...
The console, controller and disc SVGs are original pixel-grid UI assets. Pixelify Sans is self-hosted from [Google Fonts](https://github.com/google/fonts/tree/main/ofl/pixelifysans); its OFL license is included beside the font.
